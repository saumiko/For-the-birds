...
{
    public static Image cloud1 = new ImageIcon("Files/Images/cloud1.png").getImage();
    public static Image cloud2 = new ImageIcon("Files/Images/cloud2.png").getImage();
    public static Image cloud3 = new ImageIcon("Files/Images/cloud3.png").getImage();
    public static Image cloud4 = new ImageIcon("Files/Images/cloud4.png").getImage();
